...
public class Path_AStar
{
    ...
    {
        Path_Node<Tile> goal = world.tileGraph.nodes[tileEnd];
        ...
        Run(world, tileStart, hasReachedGoal, costHeuristic);
    }

    public Path_AStar(World world, Tile tileStart, string objectType, int desiredAmount = 0, bool canTakeFromStockpile = false, bool lookingForFurn = false)
    {
    ...
    protected delegate bool GoalReachedEvaluator(Path_Node<Tile> a);

    protected delegate float CostEstimator(Path_Node<Tile> a);
